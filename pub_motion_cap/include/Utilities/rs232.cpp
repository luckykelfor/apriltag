...
struct termios new_port_settings,
       old_port_settings[27];

char comports[27][13]={"/dev/ttyS0","/dev/ttyS1","/dev/ttyS2","/dev/ttyS3","/dev/ttyS4","/dev/ttyS5",
                       "/dev/ttyS6","/dev/ttyS7","/dev/ttyS8","/dev/ttyS9","/dev/ttyS10","/dev/ttyS11",
                       "/dev/ttyS12","/dev/ttyS13","/dev/ttyS14","/dev/ttyS15","/dev/ttyUSB0",
                       "/dev/ttyUSB1","/dev/ttyUSB2","/dev/ttyUSB3","/dev/ttyUSB4","/dev/ttyUSB5","/dev/ttyACM0","/dev/pts/5","/dev/pts/6","/dev/pts/7","/dev/pts/8"};
...
int OpenComport(int comport_number, int baudrate)
{
  ...
  if((comport_number>26)||(comport_number<0))
  {
